...
sqlite3 $DATA_DB_FULL_PATH '.read ./data_db/change_textures_data.sql'
sqlite3 $DATA_DB_FULL_PATH '.read ./data_db/coordinates_data.sql'
sqlite3 $DATA_DB_FULL_PATH '.read ./data_db/movements_data.sql'
...
sqlite3 $DATA_DB_FULL_PATH '.read ./data_db/dialog_sections_data.sql'
